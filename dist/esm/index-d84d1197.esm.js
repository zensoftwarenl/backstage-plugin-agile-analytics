...
import { g as getStartDate, a as getEndDate, b as agileAnalyticsApiRef, c as getUniqueTasks, f as filterDataEvents, d as formatPlotLines, e as capitalizeFirstLetter, h as generateErrorBudgetChartOptionsBase, i as generateEventsChartOptionsBase } from './index-299257c9.esm.js';
...
const AaDoraChart = ({
  ...
  }, (_d = charts[0].title) == null ? void 0 : _d.label), ((_e = charts[0]) == null ? void 0 : _e.description) ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    style: { marginTop: 20, marginLeft: 4, cursor: "pointer" },
    onMouseOver: () => setInfoHoverStatus(true),
    onFocus: () => setInfoHoverStatus(true),
    onMouseOut: () => setInfoHoverStatus(false),
...
const AaSprintInsightsTable = ({
  ...
  const latestTasksWithUniqueParent = getUniqueTasks(tickets).sort((a, b) => b.timestamp - a.timestamp);
  const parentTaskWithSubTasks = [];
  latestTasksWithUniqueParent == null ? void 0 : latestTasksWithUniqueParent.forEach((uniqueTask) => {
    var _a, _b;
    const parentTaskWithLatestTimestamp = { ...uniqueTask, isParent: true };
    if ((_a = uniqueTask == null ? void 0 : uniqueTask.subtasks) == null ? void 0 : _a.length) {
      const parentHours = (uniqueTask == null ? void 0 : uniqueTask.reported_hours) ? uniqueTask == null ? void 0 : uniqueTask.reported_hours : 0;
      const combinedHours = (_b = uniqueTask == null ? void 0 : uniqueTask.subtasks) == null ? void 0 : _b.reduce((acc, subtask) => {
        if (subtask == null ? void 0 : subtask.reported_hours) {
          return acc + (subtask == null ? void 0 : subtask.reported_hours);
        }
        return acc;
      }, parentHours);
      ...
      parentTaskWithSubTasks.push(...uniqueTask == null ? void 0 : uniqueTask.subtasks);
    } else {
  ...
  const formattedTableData = parentTaskWithSubTasks.map((ticket) => {
    ...
    const formattedTicket = {
      ...
      hours: ticket.hours,
      label: (_c = (_b = ticket == null ? void 0 : ticket.label) == null ? void 0 : _b.split(" ").map((word) => word[0].toUpperCase() + word.slice(1)).join(" ")) != null ? _c : "",
      confidence: ((_d = ticket == null ? void 0 : ticket.predictions) == null ? void 0 : _d.length) ? +(ticket == null ? void 0 : ticket.predictions[0].value) : null,
      subtasks: ((_e = ticket == null ? void 0 : ticket.subtasks) == null ? void 0 : _e.length) ? ticket.subtasks.map((subtask) => {
        var _a2, _b2;
        return {
          ...
          hours: subtask.hours,
          label: "",
          confidence: ((_b2 = subtask == null ? void 0 : subtask.predictions) == null ? void 0 : _b2.length) ? +(subtask == null ? void 0 : subtask.predictions[0].value) : null
        };
      }) : null
    };
...
function Row(props) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(TableRow, null, /* @__PURE__ */ React.createElement(TableCell, {
  ...
  }, ((_a = row == null ? void 0 : row.subtasks) == null ? void 0 : _a.length) ? /* @__PURE__ */ React.createElement(IconButton, {
    onClick: () => setOpen(!open)
  }, open ? /* @__PURE__ */ React.createElement(KeyboardArrowUp, null) : /* @__PURE__ */ React.createElement(KeyboardArrowDown, null)) : null), /* @__PURE__ */ React.createElement(TableCell, {
    padding: "none",
    component: "th",
    scope: "row",
    style: { width: "10%", paddingTop: 4, paddingBottom: 4 }
  }, moment(row["date event"] * 1e3).format("DD-MM-YYYY HH:mm")), /* @__PURE__ */ React.createElement(TableCell, {
    ...
    style: { width: "7%", paddingTop: 4, paddingBottom: 4 },
    padding: "none"
  }, row == null ? void 0 : row.label), /* @__PURE__ */ React.createElement(TableCell, {
    style: { width: "9%", paddingTop: 4, paddingBottom: 4 }
  }, (row == null ? void 0 : row.confidence) ? /* @__PURE__ */ React.createElement(LinearGauge, {
    value: row == null ? void 0 : row.confidence
  }) : null)), /* @__PURE__ */ React.createElement(TableRow, null, /* @__PURE__ */ React.createElement(TableCell, {
    style: {
      paddingBottom: 0,
      paddingTop: 0,
      paddingLeft: 0,
    ...
    timeout: "auto",
    unmountOnExit: true
  }, /* @__PURE__ */ React.createElement(Table, null, /* @__PURE__ */ React.createElement(TableBody, null, (_b = row == null ? void 0 : row.subtasks) == null ? void 0 : _b.map((subtask) => /* @__PURE__ */ React.createElement(TableRow, {
...
const AaKudosLast = ({
  ...
  const createFromToTitle = () => {
    const fromUser = users.data.find((user) => user.hash === (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.from));
    const from = fromUser ? fromUser.user_name : "";
    const toUser = users.data.find((user) => user.hash === (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.to));
  ...
  const createChannelTitle = () => {
    var _a;
    const channel = (_a = kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo) == null ? void 0 : _a.channel;
    return /* @__PURE__ */ React.createElement(Box, {
      sx: { color: "#ccc" }
    }, "#", /* @__PURE__ */ React.createElement("span", {
      className: ""
  ...
  const getEmojisFromMessage = () => {
    const message = (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.message) ? kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.message : "";
    const emojiInMessageQuantity = (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.amount) ? kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo.amount : "0";
    const regex = /:[^\s]*:/gm;
    ...
    }, "+", emojiInMessageQuantity), /* @__PURE__ */ React.createElement(Box, null, listOfEmojis.map((emoji) => {
      if (emoji == null ? void 0 : emoji.imgUrl) {
        return /* @__PURE__ */ React.createElement("img", {
          src: emoji == null ? void 0 : emoji.imgUrl,
          className: "emoji-medium",
          alt: emoji == null ? void 0 : emoji.codepoint,
          key: emoji == null ? void 0 : emoji.codepoint
        });
      }
  ...
  const transformMessageWithEmoji = () => {
    ...
    const newmess = partOfStr.map((str, index) => {
      ...
      return /* @__PURE__ */ React.createElement(Fragment, {
        key: `${index}${emoji}`
      }, str, (emoji == null ? void 0 : emoji.imgUrl) ? /* @__PURE__ */ React.createElement("img", {
        src: emoji == null ? void 0 : emoji.imgUrl,
        className: "emoji-small",
        alt: emoji == null ? void 0 : emoji.codepoint,
        key: emoji == null ? void 0 : emoji.codepoint
      }) : /* @__PURE__ */ React.createElement(Emoji, {
        unified: emoji == null ? void 0 : emoji.shortcode,
        size: 18
      }));
    });
    return newmess;
  ...
  const getContent = () => {
    if (+(kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.total_kudos) === 0 || (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo) && Object.keys(kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.last_kudo).length === 0) {
...
const AaKudosTotal = ({
  ...
  const createEmojiList = () => {
    return kudos.map((emoji) => {
      if (emoji == null ? void 0 : emoji.imgUrl) {
        return /* @__PURE__ */ React.createElement("img", {
          src: emoji == null ? void 0 : emoji.imgUrl,
          alt: emoji == null ? void 0 : emoji.shortcode,
          className: "emoji-big",
          key: emoji == null ? void 0 : emoji.codepoint
        });
      }
  ...
  const createContent = () => {
    if ((kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.total_kudos) !== null) {
      if (+(kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.total_kudos) === 0) {
      ...
      }, "+", (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.total_kudos) ? kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.total_kudos : 0), /* @__PURE__ */ React.createElement("div", {
...
const AaKudosLeaderboard = ({
  ...
  const createList = () => {
    if (selectedTeam === "all") {
      ...
      const sortedList = (kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.team_members_list.length) > 0 ? [...kudosLeaderBoard == null ? void 0 : kudosLeaderBoard.team_members_list] : teamUsers.map((userHash) => ({
        hash: userHash,
        emoji_quantity: 0,
        rank: 1
      }));
...
function LeaderbordBodyRow({
  ...
  return /* @__PURE__ */ React.createElement(ListItem, {
    ...
    if (emojiItem == null ? void 0 : emojiItem.imgUrl) {
      return /* @__PURE__ */ React.createElement("img", {
        src: emojiItem == null ? void 0 : emojiItem.imgUrl,
        alt: emojiItem == null ? void 0 : emojiItem.shortcode,
        className: "emoji-xs",
        key: emojiItem == null ? void 0 : emojiItem.codepoint
      });
    }
    return /* @__PURE__ */ React.createElement(Emoji, {
...
const AaKudosChart = ({
  ...
  const getUserName = (userHash) => {
    ...
    return (_c = (_b2 = users == null ? void 0 : users.data) == null ? void 0 : _b2.find((user) => user.hash === hash)) == null ? void 0 : _c.user_name;
  };
  ...
  } else if (!(kudosSankeyState == null ? void 0 : kudosSankeyState.value) || !((_b = kudosSankeyState == null ? void 0 : kudosSankeyState.value) == null ? void 0 : _b.length)) {
    return /* @__PURE__ */ React.createElement(Typography, {
      component: "p"
    }, "No data");
  }
...
//# sourceMappingURL=index-d84d1197.esm.js.map
