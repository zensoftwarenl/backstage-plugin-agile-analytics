...
const getUniqueTasks = (arr) => {
  const uniqueListofParents = arr == null ? void 0 : arr.reduce((acc, item) => {
    if (!(item == null ? void 0 : item.parent)) {
      return [...acc, item];
    }
    if (!(arr == null ? void 0 : arr.find((arrItem) => {
      var _a;
      return (arrItem == null ? void 0 : arrItem.key) === ((_a = item == null ? void 0 : item.parent) == null ? void 0 : _a.key);
    }))) {
      if (!(acc == null ? void 0 : acc.find((accItem) => {
        var _a;
        return (accItem == null ? void 0 : accItem.key) === ((_a = item == null ? void 0 : item.parent) == null ? void 0 : _a.key);
      }))) {
        return [...acc, { ...item == null ? void 0 : item.parent, timestamp: item == null ? void 0 : item.timestamp }];
      }
    }
    return acc;
  }, []);
  const uniqueListOfLatest = uniqueListofParents == null ? void 0 : uniqueListofParents.map((item) => {
    const subtasks = arr == null ? void 0 : arr.filter((ticket) => {
      var _a;
      return ((_a = ticket == null ? void 0 : ticket.parent) == null ? void 0 : _a.key) === (item == null ? void 0 : item.key);
    });
    if (subtasks == null ? void 0 : subtasks.length) {
      const latestTimestamp = subtasks == null ? void 0 : subtasks.reduce((acc, subtask) => {
        if ((subtask == null ? void 0 : subtask.timestamp) > acc) {
          return subtask == null ? void 0 : subtask.timestamp;
        }
        return acc;
      }, item == null ? void 0 : item.timestamp);
...
const AgileAnalyticsPage = agileAnalyticsPlugin.provide(createRoutableExtension({
  ...
  component: () => import('./index-6005e312.esm.js').then((m) => m.AaMainPageComponent),
  mountPoint: rootRouteRef
}));

export { AgileAnalyticsPage as A, getEndDate as a, agileAnalyticsApiRef as b, getUniqueTasks as c, formatPlotLines as d, capitalizeFirstLetter as e, filterDataEvents as f, getStartDate as g, generateErrorBudgetChartOptionsBase as h, generateEventsChartOptionsBase as i, agileAnalyticsPlugin as j };
//# sourceMappingURL=index-febd84fb.esm.js.map
